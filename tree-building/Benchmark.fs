...
type Benchmarks() =
    ...
    let inputs =
        [ oneNode; threeNodesInOrder; threeNodesInReverseOrder; moreThanTwoChildren; binaryTree; unbalancedTree ]

    [<Benchmark(Baseline = true)>]
    member __.Baseline() = inputs |> run TreeBuildingBaseline.buildTree
