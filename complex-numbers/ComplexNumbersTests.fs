...
[<Fact>]
let ``Real part of a purely real number``() = real (create 1.0 0.0) |> should equal 1.0

[<Fact>]
let ``Real part of a purely imaginary number``() = real (create 0.0 1.0) |> should equal 0.0

[<Fact>]
let ``Real part of a number with real and imaginary part``() = real (create 1.0 2.0) |> should equal 1.0

[<Fact>]
let ``Imaginary part of a purely real number``() = imaginary (create 1.0 0.0) |> should equal 0.0

[<Fact>]
let ``Imaginary part of a purely imaginary number``() = imaginary (create 0.0 1.0) |> should equal 1.0

[<Fact>]
let ``Imaginary part of a number with real and imaginary part``() = imaginary (create 1.0 2.0) |> should equal 2.0
...
[<Fact>]
let ``Absolute value of a positive purely real number``() = abs (create 5.0 0.0) |> should equal 5.0

[<Fact>]
let ``Absolute value of a negative purely real number``() = abs (create -5.0 0.0) |> should equal 5.0
...
[<Fact>]
let ``Absolute value of a number with real and imaginary part``() = abs (create 3.0 4.0) |> should equal 5.0
