...
[<Fact>]
let ``Ability modifier for score 3 is -4``() = modifier 3 |> should equal -4

[<Fact>]
let ``Ability modifier for score 4 is -3``() = modifier 4 |> should equal -3

[<Fact>]
let ``Ability modifier for score 5 is -3``() = modifier 5 |> should equal -3

[<Fact>]
let ``Ability modifier for score 6 is -2``() = modifier 6 |> should equal -2

[<Fact>]
let ``Ability modifier for score 7 is -2``() = modifier 7 |> should equal -2

[<Fact>]
let ``Ability modifier for score 8 is -1``() = modifier 8 |> should equal -1

[<Fact>]
let ``Ability modifier for score 9 is -1``() = modifier 9 |> should equal -1

[<Fact>]
let ``Ability modifier for score 10 is 0``() = modifier 10 |> should equal 0

[<Fact>]
let ``Ability modifier for score 11 is 0``() = modifier 11 |> should equal 0

[<Fact>]
let ``Ability modifier for score 12 is +1``() = modifier 12 |> should equal 1

[<Fact>]
let ``Ability modifier for score 13 is +1``() = modifier 13 |> should equal 1

[<Fact>]
let ``Ability modifier for score 14 is +2``() = modifier 14 |> should equal 2

[<Fact>]
let ``Ability modifier for score 15 is +2``() = modifier 15 |> should equal 2

[<Fact>]
let ``Ability modifier for score 16 is +3``() = modifier 16 |> should equal 3

[<Fact>]
let ``Ability modifier for score 17 is +3``() = modifier 17 |> should equal 3

[<Fact>]
let ``Ability modifier for score 18 is +4``() = modifier 18 |> should equal 4
